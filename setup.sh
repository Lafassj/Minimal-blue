...
# Author: Luis Freitez (aka @r1vs3c)
...
if [ "$user" == "root" ]; then
	...
	cp -rv $dir/scripts/*.sh ~/.config/polybar/shades/scripts/
	touch ~/.config/polybar/shades/scripts/target
	echo -e "\n${greenColour}[+] Done\n${endColour}"
	sleep 1.5
	...
	chmod +x ~/.config/polybar/shades/launch.sh
	chmod +x ~/.config/polybar/shapes/scripts/*
	sudo chmod +x /usr/local/bin/whichSystem.py
	sudo chmod +x /usr/local/share/zsh/site-functions/_bspc
	sudo chown root:root /usr/local/share/zsh/site-functions/_bspc
	sudo mkdir -p /root/.config/polybar/shades/scripts/
	sudo touch /root/.config/polybar/shades/scripts/target
	sudo ln -sfv ~/.config/polybar/shades/scripts/target /root/.config/polybar/shades/scripts/target
	cd ..
	echo -e "\n${greenColour}[+] Done\n${endColour}"
	sleep 1.5
